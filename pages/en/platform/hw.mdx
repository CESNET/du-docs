...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>GPU:</td><td>1x NVIDIA H100 NVL (PCIE/94GB)per node:</td><td>All nodes</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>GPU:</td><td>1x NVIDIA A40 per node:<br/>2x NVIDIA A100 (80GB) per node:<br/>2x NVIDIA H100 NVL (94GB) per node:<br/>4x NVIDIA P100:<br/>on-demand 1-4 NVIDIA A100 (40GB):</td><td>kub-as1 -- kub-as5<br/>kub-as6<br/>kub-cs1, kub-cs2<br/>kblack<br/>kzia</td>
    </tr>
    <tr>
