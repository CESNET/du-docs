...
Complete reference docs for resources and their allowed fields and subfields is available [online](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.30/). Don't forget right indentation!
...
It is possible to expose your deployments in [2 ways](../kubernetes/expose.html) but here we will use cluster LoadBalancer with creation of just new DNS name.
...
NOTE: in case you are having trouble with 'Config not found' error message, see [here](../kubernetes/kubectl) for further information
