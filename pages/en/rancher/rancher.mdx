...
The _Rancher_ instance is available at [rancher.cloud.e-infra.cz](https://rancher.cloud.e-infra.cz). Please log in using e-INFRA CZ, Life Science Login (ELIXIR) or EGI Check-In.
...
Assigned clusters that you are allowed to access can be found in the upper left corner or in th e list on the home page:
