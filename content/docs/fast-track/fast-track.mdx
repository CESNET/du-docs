...
Use this page to quickly **choose a service** from a set of services we offer and set it up so that it works for you on the basic level in less than an hour. This fast process requires an **average experienced** computer user. Once you have the service up and running, you will be offered a set of **follow-up options** to fine-tune the storage and its properties.
...
%%    R(("`Well...`"))
    ...
    T(("`Use *multiuser S3 storage* service (Virtual Organization = VO)`"))
...
%%    O -->|I do not know| R
    ...
    P -->|"`a group of people (possible accross institutions)<br/>or instruments or devices`"| T
```
