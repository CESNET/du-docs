...
%%    F{"`I am an expert/developer/application maintainer, I undrestand principles of S3/RBD and I know what I need`"}
...
%%    J(("`*Contact us* Specify your setup and ideas / requirements`"))
...
%%    B -->|yes| D
    D -->|yes| E
    D -->|no| M
    M -->|"daily operational data (documents, graphics, tables, processed experimental data, ...)"| Q
    M -->|raw research data, archives, backups, device or instrumentations outputs| P
    M -->|hard to say| N
%%   N -->|I do not care| O
    N -->|yes| Q
    N -->|no| P
